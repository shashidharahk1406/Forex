...
import { TotalApplicantsWhatsappComponent } from '../../total-applicants/total-applicants-whatsapp/total-applicants-whatsapp.component';
...
@Component({
  selector: 'app-total-verified-table',
  templateUrl: './total-verified-table.component.html',
  styleUrls: ['./total-verified-table.component.css']
})
export class TotalVerifiedTableComponent implements  AfterViewInit {
  ...
  downloadLeadList(){
    const dialogRef = this.dialog.open(DownloadTotalVerifiedEnquiriesComponent, {
      width:'35%'
    });
  ...
  openSMS(){
    const dialogRef = this.dialog.open(TotalVerifiedEnquiriesSmsDownloadComponent, {
      width:'35%'
    });
    dialogRef.disableClose=true
    dialogRef.afterClosed().subscribe((result:any) => {
  ...
  openEmail(){
    const dialogRef = this.dialog.open(TotalVerifiedEnquiriesMailComponent, {
      width:'35%'
    });
    dialogRef.disableClose=true
