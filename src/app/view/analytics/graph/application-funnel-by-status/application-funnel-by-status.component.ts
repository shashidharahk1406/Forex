...
@Component({
  selector: 'app-application-funnel-by-status',
  templateUrl: './application-funnel-by-status.component.html',
  styleUrls: ['./application-funnel-by-status.component.css']
})
export class ApplicationFunnelByStatusComponent implements OnInit {
