...
@Component({
  selector: 'app-application-count-by-source',
  templateUrl: './application-count-by-source.component.html',
  styleUrls: ['./application-count-by-source.component.css']
})
export class ApplicationCountBySourceComponent implements OnInit {
