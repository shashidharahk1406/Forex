...
@Component({
  selector: 'app-lead-count-by-source',
  templateUrl: './lead-count-by-source.component.html',
  styleUrls: ['./lead-count-by-source.component.css']
})
export class LeadCountBySourceComponent implements OnInit {
  ...
  openFilter(){
    const dialogRef = this.dialog.open(LeadCountBySourceComponent, {
      width: '50%',
    });
