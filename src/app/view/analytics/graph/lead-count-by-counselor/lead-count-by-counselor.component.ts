...
@Component({
  selector: 'app-lead-count-by-counselor',
  templateUrl: './lead-count-by-counselor.component.html',
  styleUrls: ['./lead-count-by-counselor.component.css']
})
export class LeadCountByCounselorComponent implements OnInit {
