...
@Component({
  selector: 'app-missed-followup-table',
  templateUrl: './missed-followup-table.component.html',
  styleUrls: ['./missed-followup-table.component.css']
})
export class MissedFollowupTableComponent implements AfterViewInit {
