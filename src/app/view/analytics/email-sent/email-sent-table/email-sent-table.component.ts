...
@Component({
  selector: 'app-email-sent-table',
  templateUrl: './email-sent-table.component.html',
  styleUrls: ['./email-sent-table.component.css']
})
export class EmailSentTableComponent implements AfterViewInit {
