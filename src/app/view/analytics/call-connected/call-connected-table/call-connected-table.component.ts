...
@Component({
  selector: 'app-call-connected-table',
  templateUrl: './call-connected-table.component.html',
  styleUrls: ['./call-connected-table.component.css']
})
export class CallConnectedTableComponent implements AfterViewInit {
