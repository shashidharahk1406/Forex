...
@Component({
  selector: 'app-total-re-enquiries-table',
  templateUrl: './total-re-enquiries-table.component.html',
  styleUrls: ['./total-re-enquiries-table.component.css']
})
export class TotalReEnquiriesTableComponent implements  AfterViewInit {
