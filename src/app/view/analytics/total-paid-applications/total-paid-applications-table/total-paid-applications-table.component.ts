...
import { TotalApplicantsSmsDownloadComponent } from '../../total-applicants/total-applicants-sms-download/total-applicants-sms-download.component';
...
@Component({
  selector: 'app-total-paid-applications-table',
  templateUrl: './total-paid-applications-table.component.html',
  styleUrls: ['./total-paid-applications-table.component.css']
})
export class TotalPaidApplicationsTableComponent implements AfterViewInit {
  ...
  downloadLeadList(){
    const dialogRef = this.dialog.open(DownloadTotalPaidApplicationsComponent, {
      width:'35%'
    });
  ...
  openSMS(){
    const dialogRef = this.dialog.open(TotalApplicantsSmsDownloadComponent, {
      width:'35%'
    });
    dialogRef.disableClose=true
    dialogRef.afterClosed().subscribe((result:any) => {
  ...
  openEmail(){
    const dialogRef = this.dialog.open(TotalPaidApplicationsMailComponent, {
      width:'35%'
    });
    dialogRef.disableClose=true
  ...
  openWhatsapp(){
    const dialogRef = this.dialog.open(TotalPaidApplicationsWhatsappComponent, {
      width:'35%'
    });
    dialogRef.disableClose=true
    dialogRef.afterClosed().subscribe((result:any) => {
