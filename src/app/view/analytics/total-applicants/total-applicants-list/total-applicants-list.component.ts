...
@Component({
  selector: 'app-total-applicants-list',
  templateUrl: './total-applicants-list.component.html',
  styleUrls: ['./total-applicants-list.component.css']
})
export class TotalApplicantsListComponent implements AfterViewInit {
  ...
  downloadLeadList(){
    const dialogRef = this.dialog.open(DownloadTotalApplicantsComponent, {
      width:'35%'
    });
  ...
  openEmail(){
    const dialogRef = this.dialog.open(TotalApplicantsMailComponent, {
      width:'35%'
    });
