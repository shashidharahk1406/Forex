...
@Component({
  selector: 'app-sms-sent-table',
  templateUrl: './sms-sent-table.component.html',
  styleUrls: ['./sms-sent-table.component.css']
})
export class SmsSentTableComponent implements AfterViewInit {
