...
@Component({
  selector: 'app-registered-application-table',
  templateUrl: './registered-application-table.component.html',
  styleUrls: ['./registered-application-table.component.css']
})
export class RegisteredApplicationTableComponent implements  AfterViewInit {
