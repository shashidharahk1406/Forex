...
@Component({
  selector: 'app-total-enrollments-table',
  templateUrl: './total-enrollments-table.component.html',
  styleUrls: ['./total-enrollments-table.component.css']
})
export class TotalEnrollmentsTableComponent implements AfterViewInit {
