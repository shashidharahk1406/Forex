...
@Component({
  selector: 'app-my-followup-card',
  templateUrl: './my-followup-card.component.html',
  styleUrls: ['./my-followup-card.component.css']
})
export class MyFollowupCardComponent implements OnInit {
