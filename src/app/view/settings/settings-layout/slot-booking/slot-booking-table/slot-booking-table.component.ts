...
@Component({
  selector: 'app-slot-booking-table',
  templateUrl: './slot-booking-table.component.html',
  styleUrls: ['./slot-booking-table.component.css']
})
export class SlotBookingTableComponent implements AfterViewInit {
