...
@Component({
  selector: 'app-add-assignment-rule',
  templateUrl: './add-assignment-rule.component.html',
  styleUrls: ['./add-assignment-rule.component.css']
})
export class AddAssignmentRuleComponent implements OnInit {
