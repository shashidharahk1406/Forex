...
@Component({
  selector: 'app-assignment-rule-table',
  templateUrl: './assignment-rule-table.component.html',
  styleUrls: ['./assignment-rule-table.component.css']
})
export class AssignmentRuleTableComponent implements AfterViewInit {
  ...
  uploadLeads(): void{
    ...
    this._bottomSheet.open(AddAssignmentRuleComponent,config);
  }
  }
