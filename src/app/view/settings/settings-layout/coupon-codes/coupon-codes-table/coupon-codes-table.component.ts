...
@Component({
  selector: 'app-coupon-codes-table',
  templateUrl: './coupon-codes-table.component.html',
  styleUrls: ['./coupon-codes-table.component.css']
})
export class CouponCodesTableComponent implements AfterViewInit {
