...
@Component({
  selector: 'app-whatsapp-template-table',
  templateUrl: './whatsapp-template-table.component.html',
  styleUrls: ['./whatsapp-template-table.component.css']
})
export class WhatsappTemplateTableComponent implements AfterViewInit {
