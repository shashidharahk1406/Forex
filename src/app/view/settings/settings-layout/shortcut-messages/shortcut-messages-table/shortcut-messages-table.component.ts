...
@Component({
  selector: 'app-shortcut-messages-table',
  templateUrl: './shortcut-messages-table.component.html',
  styleUrls: ['./shortcut-messages-table.component.css']
})
export class ShortcutMessagesTableComponent implements AfterViewInit {
