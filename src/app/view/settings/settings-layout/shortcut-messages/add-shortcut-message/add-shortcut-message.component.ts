...
@Component({
  selector: 'app-add-shortcut-message',
  templateUrl: './add-shortcut-message.component.html',
  styleUrls: ['./add-shortcut-message.component.css']
})
export class AddShortcutMessageComponent implements OnInit {
