...
@Component({
  selector: 'app-failed-leads-upload',
  templateUrl: './failed-leads-upload.component.html',
  styleUrls: ['./failed-leads-upload.component.css']
})
export class FailedLeadsUploadComponent implements OnInit {
