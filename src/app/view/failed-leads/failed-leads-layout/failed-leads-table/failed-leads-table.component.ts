...
@Component({
  selector: 'app-failed-leads-table',
  templateUrl: './failed-leads-table.component.html',
  styleUrls: ['./failed-leads-table.component.css']
})
export class FailedLeadsTableComponent implements AfterViewInit {
