...
@Component({
  selector: 'app-whatsapp-chat-sms',
  templateUrl: './whatsapp-chat-sms.component.html',
  styleUrls: ['./whatsapp-chat-sms.component.css'],
  animations: [
    trigger('sheetState', [
      state('open', style({
...
export class WhatsappChatSmsComponent implements OnInit {
