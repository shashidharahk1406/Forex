...
@Component({
  selector: 'app-whatsapp-chat-edit',
  templateUrl: './whatsapp-chat-edit.component.html',
  styleUrls: ['./whatsapp-chat-edit.component.css'],
  animations: [
    trigger('sheetState', [
      state('open', style({
...
export class WhatsappChatEditComponent implements OnInit {
