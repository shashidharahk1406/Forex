...
@Component({
  selector: 'app-raw-data-sms',
  templateUrl: './raw-data-sms.component.html',
  styleUrls: ['./raw-data-sms.component.css'],
  animations: [
    trigger('sheetState', [
      state('open', style({
...
export class RawDataSmsComponent implements OnInit {
