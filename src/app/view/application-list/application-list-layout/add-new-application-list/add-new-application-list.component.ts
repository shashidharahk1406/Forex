...
@Component({
  selector: 'app-add-new-application-list',
  templateUrl: './add-new-application-list.component.html',
  styleUrls: ['./add-new-application-list.component.css']
})
export class AddNewApplicationListComponent implements OnInit {
